...
namespace Torn5.Controls
{
	partial class PyramidHalfFixture
	{
		...
		private void InitializeComponent()
		{
			...
			this.numericEliminate = new System.Windows.Forms.NumericUpDown();
			this.labelEliminate = new System.Windows.Forms.Label();
			...
			((System.ComponentModel.ISupportInitialize)(this.numericEliminate)).BeginInit();
			this.SuspendLayout();
			// 
			// labelEquals
			// 
			...
			this.labelAdvance.Location = new System.Drawing.Point(224, 0);
			this.labelAdvance.Name = "labelAdvance";
			this.labelAdvance.Size = new System.Drawing.Size(64, 13);
			this.labelAdvance.TabIndex = 8;
			this.labelAdvance.Text = "To Round n";
			// 
			// labelTeamsPerGame1
			// 
			this.labelTeamsPerGame1.AutoSize = true;
			this.labelTeamsPerGame1.Location = new System.Drawing.Point(149, 0);
			...
			this.labelTitle.Text = "Repêchage n";
			// 
			// labelTeamsIn
			// 
			...
			// numericEliminate
			// 
			this.numericEliminate.Location = new System.Drawing.Point(392, 16);
			this.numericEliminate.Maximum = new decimal(new int[] {
            1000,
            0,
            0,
            0});
			this.numericEliminate.Name = "numericEliminate";
			this.numericEliminate.Size = new System.Drawing.Size(40, 20);
			this.numericEliminate.TabIndex = 12;
			this.numericEliminate.ValueChanged += new System.EventHandler(this.NumericChanged);
			// 
			// labelEliminate
			// 
			this.labelEliminate.AutoSize = true;
			this.labelEliminate.Location = new System.Drawing.Point(375, 0);
			this.labelEliminate.Name = "labelEliminate";
			this.labelEliminate.Size = new System.Drawing.Size(64, 13);
			this.labelEliminate.TabIndex = 13;
			this.labelEliminate.Text = "To Round n";
			// 
			// PyramidHalfFixture
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.labelEliminate);
			this.Controls.Add(this.numericEliminate);
			...
			this.Size = new System.Drawing.Size(439, 37);
			...
			((System.ComponentModel.ISupportInitialize)(this.numericEliminate)).EndInit();
		...
		private System.Windows.Forms.NumericUpDown numericEliminate;
		private System.Windows.Forms.Label labelEliminate;
	}
}

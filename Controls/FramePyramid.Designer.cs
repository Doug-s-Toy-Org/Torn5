namespace Torn5.Controls
{
    partial class FramePyramid
    {
        ...
        private void InitializeComponent()
        {
			...
			this.labelPyramidFinalsTeams.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			this.textDescription.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			// panelTop
			// 
			this.panelTop.Controls.Add(this.numericSample);
			this.panelTop.Controls.Add(this.label18);
			this.panelTop.Controls.Add(this.label19);
			this.panelTop.Controls.Add(this.numericPyramidFinalsGames);
			this.panelTop.Controls.Add(this.labelPyramidFinalsTeams);
			this.panelTop.Controls.Add(this.textDescription);
			this.panelTop.Controls.Add(this.label24);
			this.panelTop.Controls.Add(this.labelAdvancePercent);
			this.panelTop.Controls.Add(this.buttonIdealise);
			this.panelTop.Controls.Add(this.numericPyramidDesiredTeamsPerGame);
			this.panelTop.Controls.Add(this.label21);
			this.panelTop.Controls.Add(this.label20);
			this.panelTop.Controls.Add(this.numericPyramidGamesPerTeam);
			this.panelTop.Controls.Add(this.numericPyramidTeams);
			this.panelTop.Controls.Add(this.label17);
			this.panelTop.Controls.Add(this.numericPyramidRounds);
			this.panelTop.Controls.Add(this.label11);
			this.panelTop.Controls.Add(this.pyramidRound3);
			this.panelTop.Controls.Add(this.pyramidRound2);
			this.panelTop.Controls.Add(this.pyramidRound1);
			this.panelTop.Dock = System.Windows.Forms.DockStyle.Top;
			this.panelTop.Location = new System.Drawing.Point(0, 0);
			this.panelTop.Name = "panelTop";
			this.panelTop.Size = new System.Drawing.Size(1224, 350);
			...
			this.labelAdvancePercent.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			...
			// panelBottom
			// 
			this.panelBottom.Controls.Add(this.displayReportPyramid);
			this.panelBottom.Controls.Add(this.printReportPyramid);
			this.panelBottom.Dock = System.Windows.Forms.DockStyle.Fill;
			this.panelBottom.Location = new System.Drawing.Point(0, 350);
			this.panelBottom.Name = "panelBottom";
			this.panelBottom.Size = new System.Drawing.Size(1224, 351);
			this.panelBottom.TabIndex = 52;
			// 
			// numericSample
			// 
			this.numericSample.Location = new System.Drawing.Point(833, 74);
			this.numericSample.Name = "numericSample";
			this.numericSample.Size = new System.Drawing.Size(50, 20);
			this.numericSample.TabIndex = 53;
			this.numericSample.Visible = false;
			// 
			// displayReportPyramid
			// 
			this.displayReportPyramid.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Zoom;
			this.displayReportPyramid.Dock = System.Windows.Forms.DockStyle.Fill;
			this.displayReportPyramid.Location = new System.Drawing.Point(0, 0);
			...
			this.displayReportPyramid.Size = new System.Drawing.Size(1160, 351);
			this.displayReportPyramid.TabIndex = 50;
			// 
			// printReportPyramid
			// 
			this.printReportPyramid.DisplayReport = this.displayReportPyramid;
			this.printReportPyramid.Dock = System.Windows.Forms.DockStyle.Right;
			this.printReportPyramid.FileName = null;
			this.printReportPyramid.Location = new System.Drawing.Point(1160, 0);
			this.printReportPyramid.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.printReportPyramid.Name = "printReportPyramid";
			this.printReportPyramid.Size = new System.Drawing.Size(64, 351);

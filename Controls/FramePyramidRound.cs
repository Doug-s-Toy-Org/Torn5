...
namespace Torn5.Controls
{
	public partial class FramePyramidRound : UserControl
	{
		...
		/// <summary>Call after frame is shown to set a splitter to the correct position independent of screen scaling.</summary>
		public void SetSplit()
		{
			splitContainerTop.SplitterDistance = groupTopOrBottom.Right + 10;
		}
	}
}

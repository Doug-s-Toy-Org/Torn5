...
namespace Torn5.Controls
{
	partial class PrintReport
	{
		...
		private void InitializeComponent()
		{
			...
			this.buttonShowOnScoreboard = new System.Windows.Forms.Button();
			...
			// sendToTBoard
			// 
			this.sendToTBoard.Controls.Add(this.buttonShowOnScoreboard);
			...
			this.sendToTBoard.Size = new System.Drawing.Size(64, 520);
			this.sendToTBoard.TabIndex = 2;
			this.sendToTBoard.TabStop = false;
			this.sendToTBoard.Text = "Save As";
			// 
			// buttonShowOnScoreboard
			// 
			this.buttonShowOnScoreboard.Location = new System.Drawing.Point(6, 474);
			this.buttonShowOnScoreboard.Name = "buttonShowOnScoreboard";
			this.buttonShowOnScoreboard.Size = new System.Drawing.Size(53, 37);
			this.buttonShowOnScoreboard.TabIndex = 13;
			this.buttonShowOnScoreboard.Text = "Score board";
			this.buttonShowOnScoreboard.UseVisualStyleBackColor = true;
			this.buttonShowOnScoreboard.Click += new System.EventHandler(this.ShowOnScoreboardClicked);
			// 
			// numericScale
			// 
			...
			this.Size = new System.Drawing.Size(64, 520);
        ...
        private System.Windows.Forms.Button buttonShowOnScoreboard;
    }
}
